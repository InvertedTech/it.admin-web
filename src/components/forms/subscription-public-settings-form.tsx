...
const stripe = { Enabled: 'Data.Stripe.Enabled' } as const;
const paypal = { Enabled: 'Data.Paypal.Enabled' } as const;
const fortis = { Enabled: 'Data.Fortis.Enabled' } as const;
const manual = { Enabled: 'Data.Manual.Enabled' } as const;
const crypto = { Enabled: 'Data.Crypto.Enabled' } as const;
...
export function SubscriptionPublicSettingsForm({ base }: Props) {
	...
	const form = useProtoAppForm({
		...
		onSubmitAsync: async ({ value }) => {
			const { modifyPublicSubscriptionSettings } = await import(
