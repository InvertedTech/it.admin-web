...
type Props = { msftRedirect: string; from?: string; mode?: 'azure' | 'form' };
...
function AzureLoginForm({ msftRedirect }: { msftRedirect: string }) {
						...
						<div className='flex items-center gap-2'>
							...
							<Tooltip>
								...
								<TooltipContent side='top' align='start'>
									Enable if your account requires an
									authenticator code.
								</TooltipContent>
							</Tooltip>
						</div>
...
export function LoginForm({ msftRedirect, from, mode = 'form' }: Props) {
	if (mode === 'azure') {
		return <AzureLoginForm msftRedirect={msftRedirect} />;
	}
	return <CredentialsLoginForm msftRedirect={msftRedirect} from={from} />;
}
